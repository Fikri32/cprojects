...
export const DashboardMenu = [
	...
	},
	{
		...
		icon: 'layers',
		children: [
			{ id: uuid(), link: '/admin/pages/profile', name: 'Profile' },
			{ id: uuid(), link: '/admin/pages/settings', name: 'Settings'},
			{ id: uuid(), link: '/admin/pages/billing', name: 'Billing' },
			{ id: uuid(), link: '/admin/pages/pricing', name: 'Pricing'},
